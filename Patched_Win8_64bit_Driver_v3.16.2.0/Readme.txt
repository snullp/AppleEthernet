...
1. SpeedDuplex: Set the Ethernet link speed.
   ...
   -10Half:       Set the Ethernet works on 10HD
   -10Full:       Set the Ethernet works on 10FD
   -100Half:      Set the Ethernet works on 100HD
   -100Full:      Set the Ethernet works on 100FD
...
21. WolPatterbType: Select the Wake-Up Frame patterns
   -Dynamic        Use the Wake-up frame patterns provided by Windows
   -Hardcode       Use the fixed wake-up frame patterns
